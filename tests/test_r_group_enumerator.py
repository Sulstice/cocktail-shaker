...
def test_validation_smiles():
    ...
    """
    molecule_success = Cocktail(["c1cc(CCCO)ccc1"])
...
def test_primary_finding_r_groups():
    ...
    # Alcohols
    # --------
    primary_alcohol_molecule = Cocktail(["c1cc(CCCO)ccc1"])
    ...
    # Aldehydes
    # ---------
    # aldehyde_molecule = Cocktail(('C1=CC=C(C=C1)C=O'))
    ...
    acetic_anhydride_molecule = Cocktail(['c1cc(CCCCC(=O)OC(=O)C)ccc1'])
    ...
    # Acyl Halides
    # ------------
    acyl_chloride_molecule = Cocktail(['c1cc(CCC(C(=O)Cl))ccc1'])
    ...
    acyl_bromide_molecule = Cocktail(['c1cc(CCC(C(=O)Br))ccc1'])
    ...
    acyl_fluoride_molecule = Cocktail(['c1cc(CCC(C(=O)F))ccc1'])
    ...
    acyl_iodide_molecule = Cocktail(['c1cc(CCC(C(=O)I))ccc1'])
    ...
    # Amides
    # ------
    amide_molecule = Cocktail(['C1=CC=C(C=C1)C(=O)N'])
    ...
    # Ketones
    # -------
    ketone_molecule = Cocktail(['c1cc(CCCC(=O)OC)ccc1'])
    ...
    primary_carboxylic_acid = Cocktail(["C1C(CCCC1)CCC(=O)O"])
    ...
    # Azides
    # azide_molecule = Cocktail(('c1cc(CCC([N-][N+]#N))ccc1'))
    ...
    # Amines
    primary_amine_molecule = Cocktail(['c1cc(CCCN)ccc1'])
    ...
    secondary_amine_molecule = Cocktail(['c1cc(CCCNC)ccc1'])
    ...
    enamine_amine_molecule = Cocktail(['CC(=CC(=O)OC)N'])
